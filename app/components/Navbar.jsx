  ...
  return (
    <>
      ...
      flex items-center justify-between z-50 ${
        isScrolling ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""
      } `}
      >
        <a href="">
          <Image
        ...
        <ul
          className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3  ${
            isScrolling ? "" : "bg-white shadow-sm bg-opacity-50"
          } `}
        >
          <li>
        ...
        <div className="flex items-center gap-4">
          ...
          <ul
            ref={sideMenuRef}
            className="md:hidden flex flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 trasition duration-500"
          >
            <div
